  ...
  return (
    <div className="p-6 lg:p-10 space-y-6 animate-in-up">
      <header className="flex flex-wrap items-end justify-between gap-4">
        ...
        <Button onClick={() => navigate({ to: "/orcamentos/novo", search: {} })} className="bg-gradient-gold text-primary-foreground shadow-gold">
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-16 border border-dashed border-border rounded-lg">
          ...
          <Button onClick={() => navigate({ to: "/orcamentos/novo", search: {} })} className="mt-4 bg-gradient-gold text-primary-foreground shadow-gold">
